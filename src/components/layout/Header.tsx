  ...
  return (
    <header className="flex items-center gap-3 w-full">
      ...
      <button
        ...
        className="shrink-0 flex items-center gap-2 px-3.5 py-2 bg-red-50 hover:bg-red-100 text-red-600 border border-red-200 rounded-lg font-semibold transition-colors shadow-sm cursor-pointer text-sm"
        title="Sair da conta"
      >
